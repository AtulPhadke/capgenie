...
echo         ^('assets', 'assets'^),
echo     ] + collect_data_files^('inquirer'^) + collect_data_files^('Bio'^) + collect_data_files^('sklearn'^) + collect_data_files^('umap'^) + collect_data_files^('pyahocorasick'^) + collect_data_files^('logomaker'^),
echo     hiddenimports=[
